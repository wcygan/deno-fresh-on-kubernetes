// frontend/routes/products.tsx
import { Head } from "fresh/runtime";
import { define } from "../utils.ts";
import { formatMoney, listProducts, type Product } from "../lib/stripe.ts";

export default define.page(async function Products() {
    ...
    <div class="px-4 py-8 mx-auto bg-gray-50 min-h-screen">
      ...
      <div class="mx-auto max-w-6xl">
        ...
        <div class="mt-12 text-center">
          <a
            href="/"
            class="inline-flex items-center px-6 py-3 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
            ← Back to Home
          </a>
        </div>
